export class MenuManager {
  ...
  close() {
    ...
    this.root.removeEventListener("click", this.handleOutside);
    this.root.removeEventListener("keydown", this.handleKeydown);
    globalThis.removeEventListener?.("resize", this.closeBound);
    globalThis.removeEventListener?.("scroll", this.closeBound, true);
    this.menu = null;
    this.anchor = null;
  }
}
